...
struct EnvTabEntry {
    ...
    { .name = "W-PER-LINE",         .envId = ENV_WORDS_PER_LINE,    .envTyp = ENV_TYP_INT,  .rOnly = false,  .iVal = 8         },
    { .name = "VERSION",            .envId = ENV_PROG_VERSION,      .envTyp = ENV_TYP_STR,  .rOnly = false,  .sVal = nullptr   },
    { .name = "PATCH_LEVEL",        .envId = ENV_PROG_PATCH_LEVEL,  .envTyp = ENV_TYP_INT,  .rOnly = false,  .iVal = 0         },
    { .name = "STEP-IN-CLOCKS",     .envId = ENV_STEP_IN_CLOCKS,    .envTyp = ENV_TYP_BOOL, .rOnly = false,  .bVal = false     },
    
    { .name = "PASS_CNT",           .envId = ENV_PASS_CNT,          .envTyp = ENV_TYP_INT,  .rOnly = false,  .iVal = 0         },
    { .name = "FAIL_CNT",           .envId = ENV_FAIL_CNT,          .envTyp = ENV_TYP_INT,  .rOnly = false,  .iVal = 0         },
    
    { .name = "I-TLB-SETS",         .envId = ENV_I_TLB_SETS,        .envTyp = ENV_TYP_INT,  .rOnly = false,  .iVal = 1         },
    { .name = "I-TLB-SIZE",         .envId = ENV_I_TLB_SIZE,        .envTyp = ENV_TYP_INT,  .rOnly = false,  .iVal = 1024      },
    
    { .name = "D-TLB-SETS",         .envId = ENV_D_TLB_SETS,        .envTyp = ENV_TYP_INT,  .rOnly = false,  .iVal = 1         },
    { .name = "D-TLB-SIZE",         .envId = ENV_D_TLB_SIZE,        .envTyp = ENV_TYP_INT,  .rOnly = false,  .iVal = 1024      },
    
    { .name = "I-CACHE-SETS",       .envId = ENV_I_CACHE_SETS,      .envTyp = ENV_TYP_INT,  .rOnly = false,  .iVal = 1         },
    { .name = "I-CACHE-SIZE",       .envId = ENV_I_CACHE_SIZE,      .envTyp = ENV_TYP_INT,  .rOnly = false,  .iVal = 1024      },
    { .name = "I-CACHE-LINE-SIZE",  .envId = ENV_I_CACHE_SIZE,      .envTyp = ENV_TYP_INT,  .rOnly = false,  .iVal = 4         },
    
    { .name = "D-CACHE-SETS",       .envId = ENV_D_CACHE_SETS,      .envTyp = ENV_TYP_INT,  .rOnly = false,  .iVal = 1         },
